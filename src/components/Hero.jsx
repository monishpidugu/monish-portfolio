...
export default function Hero() {
  ...
  return (
    <section className="hero" id="hero">
      ...
      {/* Photo — full right side with left fade */}
      <div className="hero__photo-wrap" aria-hidden>
        <img src="/monish.jpg" alt="" className="hero__photo" />
        <div className="hero__photo-fade" />
      </div>


      <div className={`container hero__layout ${loaded ? 'hero--loaded' : ''}`}>
        <div className="hero__content">
          <p className="hero__greeting">Hi, I'm</p>

          <h1 className="hero__name">
            Pidugu Monish<br />Abhinav
          </h1>

          <div className="hero__title-row">
            <span className="hero__title-pill">
              {displayed}
          ...
          <p className="hero__bio">
            ...
            3.5+ years working on large-scale logistics SaaS at{' '}
            <span className="hero__company">Aptean</span>.
          </p>
          ...
          <div className="hero__actions">
            ...
            <a className="btn btn--icon" href="https://www.linkedin.com/in/monish-pidugu-2675691b9"
            ...
            <a className="btn btn--icon" href="https://github.com/monishpidugu"
